...
public class HttpUtils {
    ...
    public class CookieIntercetor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (s.equals("https://www.wanandroid.com/user/login")) {
                response = chain.proceed(request);
                List<String> cookies = response.headers("Set-Cookie");
                String cook = encodeCookie(cookies);
                sp.edit().putString(s, cook).apply();
            } else if (s.contains("lg/collect/list/")) {
                String cook = sp.getString("https://www.wanandroid.com/user/login", null);
                if (!TextUtils.isEmpty(cook)) {
                    Request.Builder builder = request.newBuilder().addHeader("Cookie", cook);
    ...
    private HttpUtils() {
        sp = BaseApp.getBaseApp().getSharedPreferences("mysp", Context.MODE_PRIVATE);
        //获取一个OkHttpClient
